const SendMessage = () => {
    return(
        <div className="w-full bottom-[300px] border-t-2 p-4 flex justify-center">
            <input type="text" placeholder="Type your message..." className=" border rounded-full px-4 py-2 focus:outline-none"/>
